...
class LoggingContextManager(object):
    ...
    def _set_up_logging(self):
        ...
        self._file_log_handlers = setup_logfile_logger(self.log_file)
    ...
    def _tear_down_logging(self):
        ...
        for tmp_handler in self._file_log_handlers:
            root_logger.removeHandler(tmp_handler)
